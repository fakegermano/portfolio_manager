...
from portfolio_manager.users.models import User
from portfolio_manager.users.tests.factories import UserFactory
from portfolio_manager.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
